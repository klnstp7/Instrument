function WrapTables4Dom() {
    ...
    if (arguments.length == 1) {
        return WrapTables4DomDefault(arguments[0], isShowPaging, tableWidth, bStateSave, tableHight, iDisplayLength, isQuickSearch);
    }
    else if (arguments.length == 2) {
        return WrapTables4DomDefault(arguments[0], arguments[1], tableWidth, bStateSave, tableHight, iDisplayLength, isQuickSearch);
    }
    else if (arguments.length == 3) {
        return WrapTables4DomDefault(arguments[0], arguments[1], arguments[2], bStateSave, tableHight, iDisplayLength, isQuickSearch);
    }
    else if (arguments.length == 4) {
        return WrapTables4DomDefault(arguments[0], arguments[1], arguments[2], arguments[3], tableHight, iDisplayLength, isQuickSearch);
    }
    else if (arguments.length == 5) {
        return WrapTables4DomDefault(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], iDisplayLength, isQuickSearch);
    }
    else if (arguments.length == 6) {
        return WrapTables4DomDefault(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5], isQuickSearch);
    }
    else if (arguments.length == 7) {
        return WrapTables4DomDefault(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5], arguments[6]);
    }
}
/**
...
*/
function WrapTables4DomDefault(tableId, isShowPaging, tableWidth, bStateSave, tableHight, iDisplayLength, isQuickSearch) {
...
function WrapTables4Ajax() {
    ...
    if (arguments.length == 2) {
        return WrapTables4AjaxDefault(arguments[0], arguments[1], tableWidth, isShowPaging, tableHight, bStateSave, iDisplayLength, isQuickSearch);
    }
    else if (arguments.length == 3) {
        return WrapTables4AjaxDefault(arguments[0], arguments[1], arguments[2], isShowPaging, tableHight, bStateSave, iDisplayLength, isQuickSearch);
    }
    else if (arguments.length == 4) {
        return WrapTables4AjaxDefault(arguments[0], arguments[1], arguments[2], arguments[3], tableHight, bStateSave, iDisplayLength, isQuickSearch);
    }
    else if (arguments.length == 5) {
        return WrapTables4AjaxDefault(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], bStateSave, iDisplayLength, isQuickSearch);
    }
    else if (arguments.length == 6) {
        return WrapTables4AjaxDefault(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5], iDisplayLength, isQuickSearch);
    }
    else if (arguments.length == 7) {
        return WrapTables4AjaxDefault(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5], arguments[6], isQuickSearch);
    }
    else if (arguments.length == 8) {
        return WrapTables4AjaxDefault(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5], arguments[6], arguments[7]);
    }
}
/**
* @tableId Table对应的Id值，字符串类型
...
* @bStateSave true/false，记住状态
* @iDisplayLength：每页加载记录数
* @isQuickSearch：是否搜索功能
*/
function WrapTables4AjaxDefault(tableId, ajaxSource, tableWidth, isShowPaging, tableHight, bStateSave, iDisplayLength, isQuickSearch) {
    setTableWidth(tableId, tableWidth);
...
function GetJsondataFromServ() {
    ...
    if (arguments.length == 2) {
        return GetJsondataFromServDefault(arguments[0], arguments[1], tableWidth, col, myQuerySettingInfo, tableHight, isQuickSearch, enableSort, saveCookie, isShowPaging);
    }
    else if (arguments.length == 3) {
        return GetJsondataFromServDefault(arguments[0], arguments[1], arguments[2], col, myQuerySettingInfo, tableHight, isQuickSearch, enableSort, saveCookie, isShowPaging);
    }
    else if (arguments.length == 4) {
        return GetJsondataFromServDefault(arguments[0], arguments[1], arguments[2], arguments[3], myQuerySettingInfo, tableHight, isQuickSearch, enableSort, saveCookie, isShowPaging);
    }
    else if (arguments.length == 5) {
        return GetJsondataFromServDefault(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], tableHight, isQuickSearch, enableSort, saveCookie, isShowPaging);
    }
    else if (arguments.length == 6) {
        return GetJsondataFromServDefault(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5], isQuickSearch, enableSort, saveCookie, isShowPaging);
    }
    else if (arguments.length == 7) {
        return GetJsondataFromServDefault(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5], arguments[6], enableSort, saveCookie, isShowPaging);
    }
    else if (arguments.length == 8) {
        return GetJsondataFromServDefault(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5], arguments[6], arguments[7], saveCookie, isShowPaging);
    }
    else if (arguments.length == 9) {
        return GetJsondataFromServDefault(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5], arguments[6], arguments[7], arguments[8], isShowPaging);
    }
    else if (arguments.length == 10) {
        return GetJsondataFromServDefault(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5], arguments[6], arguments[7], arguments[8], arguments[9]);
    }
}
...
*/
function GetJsondataFromServDefault(tableId, url, tableWidth, columnInfo, querySettingInfo, tableHight, isQuickSearch, enableSort, saveCookie, isShowPaging) {
    setTableWidth(tableId, tableWidth);

    var chkHeight = (isQuickSearch || isShowPaging) ? 100 : 72;
...
关于后台接收参数说明:
1、获取某个参数值:Request["search" + sName的值]
2、获取所有查询条件（不包括自定义）:
DataTableUtils.DataTableModel dtm = DataTableUtils.GetJquerydataTableParams();
dtm.FieldCondition为查询条件;
或Request["myAdVanceSearchCondition"]
3、获取自定义参数查询条件:Request[CustomParam的值];
******************************************************/
...
function AddAdvanceSearchCondition(aoColumns) {
    ...
    for (var i = 0; i < aoColumns.length; i++) {
        ...
        if (searchDataSource != null) {
            ...
            if (tmpValue != "") {
                ParamsStr += ("&search" + myName + "=" + encodeURI(tmpValue));
